...
def calculate_model_metrics():
    """Calculate comprehensive prediction accuracy metrics for all models"""
    return {
...
def main():
    ...
    with model_tab1:
        ...
        with col1:
            ...
            st.markdown("""
            **📖 COE Price Prediction Analysis:**
            - **MAPE 8.5%**: Good price accuracy for COE bidding (target: <10%)
            - **R² 0.820**: Explains 82% of COE price variance
            - **Direction 73.2%**: Strong prediction of price movements (23.2% above random)
            - **F1-Score 0.719**: Balanced precision and recall for price direction
            
            **Practical Interpretation:**
            - **MAE $8,200**: Average prediction error in SGD
            - **Precision 74.2%**: When predicting price increase, correct 74% of time
            - **Confidence Coverage 91.5%**: Actual prices fall within prediction intervals 91.5% of time
            """)
        ...
        with col3:
            ...
            **MAPE (Mean Absolute Percentage Error):**
            ...
            - 8.5% means we're typically within 8.5% of actual COE winning bid
            - For a $80,000 COE, we'd be off by about $6,800 on average
            - Lower is better - industry standard for price prediction
            ...
            **Precision & Recall:**
            - Precision: When we predict price increase, how often are we right?
            - Recall: Of all actual price increases, how many did we catch?
